...
RSpec.describe Item, type: :model do
  ...
  describe 'class methods' do
    it "finds the #five_most_popular and #five_least_popular" do
      ...
      @order_item_3= create(:fulfilled_order_item, item: @item_4, order: @order_2, quantity: 16 )
      @order_item_3= create(:fulfilled_order_item, item: @item_5, order: @order_2, quantity: 14 )
      @order_item_3= create(:fulfilled_order_item, item: @item_6, order: @order_2, quantity: 12 )
      @order_item_3= create(:fulfilled_order_item, item: @item_7, order: @order_3, quantity: 10 )
      @order_item_3= create(:fulfilled_order_item, item: @item_8, order: @order_3, quantity: 9 )
      @order_item_3= create(:fulfilled_order_item, item: @item_8, order: @order_3, quantity: 8 )
      @order_item_3= create(:fulfilled_order_item, item: @item_10, order: @order_3, quantity: 6 )
      @order_item_3= create(:fulfilled_order_item, item: @item_11, order: @order_3, quantity: 2 )
      @order_item_3= create(:fulfilled_order_item, item: @item_11, order: @order_3, quantity: 2 )
